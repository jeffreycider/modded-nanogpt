...
| 48 | 3050 | 3.2782 (n=8)✓ | Setup from PR #357 (tuned Muon + aux AdamW), with its K-Maxwell momentum replaced by MaxEntSlop momentum (256-gradient maximum-entropy kernel pair, mean age 90 to 24.05 from step 780) and Muon weight decay 0.1 following the learning-rate schedule; 3080-step clock | 2026/09/20 | [log](results/20260920_muon_maxentslop_3080/seed0.txt) | [PR](https://github.com/jeffreycider/modded-nanogpt/tree/track3-muon-maxentslop) by [@jeffreycider](https://github.com/jeffreycider) |
