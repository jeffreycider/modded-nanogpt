...
| 47 | 3050 | 3.2784 (n=8)✓ | Setup from PR #359 (MuonH fast-slow decay), with its K-Maxwell first moment replaced by MaxEntSlop momentum: a 256-gradient kernel solved by maximum entropy from four desiderata, annealed from mean age 90 to 24.05; fixed 3125-step schedule | 2026/09/20 | [log](results/20260920_muonh_maxentslop_3050/seed0.txt) | [PR](https://github.com/jeffreycider/modded-nanogpt/tree/track3-muonh-maxentslop) by [@jeffreycider](https://github.com/jeffreycider) |
