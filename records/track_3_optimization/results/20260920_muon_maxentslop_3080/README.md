# MaxEntSlop momentum on the tuned Muon baseline — 3050 steps on a 3080-step clock (n=8)
...
Model, data, batch size, learning-rate schedule, aux AdamW and Newton–Schulz are unchanged. The training clock is 3080 steps.

## Eight-seed result

Eight consecutive seeds (0–7) of this exact script, 3080-step clock, validation every 125 steps and every 10 steps from 2900,
...
| 3080 | 3.27738 | 0.00740 | passes |

Final losses at 3080 by seed: 3.27929, 3.27737, 3.27629, 3.27782, 3.27706, 3.27840, 3.27535, 3.27748. Every boundary from 3000 is in `summary.tsv`.

PR #357 reports 3160 steps (n=8, H100) as its first passing boundary on a 3250-step clock. This configuration's first passing
boundary is 3050 on a 3080-step clock, on A100s.
...
- `README_harness_runs.md`, `harness_N3080_seed0..2.txt` — the earlier three-seed development runs of the same configuration in our research harness (not part of the claim).
